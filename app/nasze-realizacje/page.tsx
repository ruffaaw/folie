...
export default function Page() {
  const galleryImages = [
    ...
    "/lustro weneckie 4.webp",
    "/lustro weneckie dom jednorodzinny.webp",
    "/lustro weneckie dom jednorodzinny (2).webp",
    "/lustro weneckie po.webp",
    "/lustro weneckie przed.webp",
    "/folia z efektem lustra weneckiego.webp",
    "/folia przeciwsłoneczna z efektem lustra.webp",
    "/folia przeciwsłoneczna.webp",
    "/folia przeciwsłoneczna (2).webp",
    "/folia przeciwsłoneczna (3).webp",
    "/folia przeciwsłoneczna, folia anty UV.webp",
    "/folia przeciwsłoneczna montaż.webp",
    "/folia mrożona.webp",
    "/folia mrożona, folia mleczna, folia matowa.webp",
    "/montaż folii okiennej (2).webp",
    "/montaż folii okiennej (3).webp",
  ];
