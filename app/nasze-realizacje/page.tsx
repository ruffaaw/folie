...
export default function Page() {
  const galleryImages = [
    "/lustro weneckie 1.jpg",
    "/lustro weneckie 2.jpg",
    "/lustro weneckie 3.jpg",
    "/lustro weneckie 4.jpg",
    "/lustro weneckie dom jednorodzinny.jpeg",
    "/lustro weneckie dom jednorodzinny (2).jpeg",
    "/lustro weneckie po.jpg",
    "/lustro weneckie przd.jpeg",
    "/folia z efektem lustra weneckiego.jpeg",
    "/folia przeciwsłoneczna z efektem lustra.jpeg",
    "/folia przeciwsłoneczna.jpeg",
    "/folia przeciwsłoneczna (2).JPG",
    "/folia przeciwsłoneczna (3).jpg",
    "/folia przeciwsłoneczna, folia anty UV.JPG",
    "/folia przeciwsłoneczna montaż.jpeg",
    "/folia mrożona.jpeg",
    "/folia mrożona, folia mleczna, folia matowa.jpg",
    "/montaż folii okiennej (2).jpeg",
    "/montaż folii okiennej (3).jpeg",
  ];
