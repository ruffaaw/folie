    ...
    <div className="mt-[100px] flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-4 w-full justify-items-center px-32 gap-5 my-10 ">
        {offers.map((offer, index) => (
          <div
            key={index}
            className="bg-white drop-shadow-[2px_2px_4px_rgba(0,0,0,0.3)] rounded-[12px]"
          >
            <div
            ...
            <div className="flex flex-col p-6 gap-2 items-stretch">
              <h3 style={{ fontSize: "1.5rem", textAlign: "justify" }}>
                {offer.title}
              </h3>
              <p
                style={{
              ...
              <Link
                href={offer.href}
                className="flex items-center justify-start gap-1 text-blue mt-2 w-fit hover:scale-110"
              >
